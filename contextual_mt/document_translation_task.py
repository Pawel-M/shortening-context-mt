...
from .contextual_list_dataset import ContextualListDataset
...
class DocumentTranslationTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            default=0,
            type=int,
            help="Limit the size of the dataset",
        )
        parser.add_argument(
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if self.args.separate_context_sentences:
            self.datasets[split] = ContextualListDataset(
                src_dataset,
                src_dataset.sizes,
                self.src_dict,
                tgt_dataset,
                ...
                shuffle=True,
                limit_size=self.args.limit_dataset_size,
            )
        else:
